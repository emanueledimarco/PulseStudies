...
RecHitSampleFourCorrector::RecHitSampleFourCorrector(){};
RecHitSampleFourCorrector::~RecHitSampleFourCorrector(){};

float RecHitSampleFourCorrector::RecHitCorrectedEnergy(const EcalRecHit *rh, float lc, float ic, float agc) {
...
float RecHitSampleFourCorrector::MultiFitParametricCorrection(float amplitude_multifit_intime_uncal, float chi2, uint32_t recoflag){
...
double RecHitSampleFourCorrector::CorrectionFunction1(double x, double chi2){
  if (x<4000) return 1;
  if (x>10000) x=10000;
  double p0   =    0.0567521;
...
double RecHitSampleFourCorrector::CorrectionFunction2(double x, double chi2){
  if (x<7000) return 1;
  if (x>18000) x=18000;
  double p0   =    0.770166;
...
double RecHitSampleFourCorrector::CorrectionFunction3(double x, double chi2){
